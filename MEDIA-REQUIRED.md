...
- **Ratio / duration / weight:** 16:9; 6–12 seconds; under 4 MB per encoded video.
- **Suggested alt:** “A SATONA plate position being marked during the offline encoding process.”
- **Desktop / mobile:** Inline muted loop with controls on desktop; poster or tap-to-play on mobile.
- **Status:** Optional for first release.
...
- **Suggested alt:** “Confirmed SATONA kit contents arranged on a neutral surface.”
- **Desktop / mobile:** Two-column feature image on desktop; full-width image above copy on mobile.
- **Status:** Required before claiming exact box contents.
...
- **Suggested alt:** “Close-up of marked and unmarked binary positions on a SATONA plate.”
- **Desktop / mobile:** Framed alongside explanation on desktop; full-width between steps on mobile.
- **Status:** Optional.
...
- **Suggested alt:** “SATONA product packaging.”
- **Desktop / mobile:** Gallery item on desktop and mobile.
- **Status:** Optional; do not show until available.
